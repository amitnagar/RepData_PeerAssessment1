...
```{r echo=TRUE}
setwd("C:\\Users\\I013285\\Documents\\GitHub\\RepData_PeerAssessment1")
activity.data<-read.table(file="C:\\Users\\I013285\\Documents\\Amit\\CourseraR\\ReproducibleResearch\\Week2\\PA1\\activity.csv",header=TRUE, sep=",")
```
